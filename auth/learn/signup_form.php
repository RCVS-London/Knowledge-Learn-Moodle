...
class login_signup_form extends moodleform implements renderable, templatable {
    public function definition() {
        ...
        committed to the privacy of your personal information and will process your data in line with 
        <a href="'.$CFG->wwwroot.'/local/staticpage/view.php?page=privacy-policy">our privacy
    ...
    public function validation($data, $files) {
        ...
        // TODO: hack alert
        // Moodle 3.8 introduced new callbacks:
        // extend_signup_form($mform) and validate_extend_signup_form($data)
        // Unfortunately, while $mform above is malleable, $data is passed by value and not reference, so removing the
        // authlib requirement to enter email address twice.
        ...
        $data['email'] = core_text::strtolower($data['email']);
